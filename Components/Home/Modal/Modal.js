...
export default function Modal({
  ...
  return (
    <>
      {displayModal ? (
        <>
          <div className="lg:grid content-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none md:inset-0 h-modal md:h-full">
