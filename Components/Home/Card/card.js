  ...
  return (
    <div className="flex-1 h-full">
      <div className="p-6 max-w-sm  rounded-lg  bg-gray-800 border-gray-200 shadow-md dark:border-gray-700 ">
        ...
        <button
          className="bg-[#E6CAB3] text-white hover:bg-[#EEE3CB] font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
          type="button"
          onClick={() => {
            setShow(true)
          }}
